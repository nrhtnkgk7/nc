...
export const chefs: Chef[] = [
  {
    ...
    bio: '1980年東京浅草生まれ。16歳でIL BOCCALONEにて修行を開始。2013年「Jean-Georges Tokyo」立ち上げから総料理長に就任。2018年「The Burn」をプロデュース。現在は「No Code」を主宰し、Chef+として国内外で活動。2026年には台北にも進出。',
    longBio: '1980年東京浅草に生まれる。幼少期から食に強い関心を持ち、16歳で料理の道を志し、IL BOCCALONEで修行をスタート。\n\n様々なお店で修行をし、2013年「Jean-Georges Tokyo」の立ち上げから総料理長に就任。2018年「The Burn」をプロデュース。フランス料理をベースにしながらも、ジャンルの枠に捕らわれない自由な発想で料理を創造する。\n\n現在は「No Code」を主宰し、「Chef+」（シェフプラス）として料理人の枠を超えた活動を展開。サステナビリティ、フードロス問題、次世代の育成など、食を通じた社会貢献に力を注ぐ。ソムリエの視点も持ち合わせ、独自のペアリングも監修。2026年には台北にも進出。',
    philosophy: '「食」は未来を創るための最幸のツール。規定に捕らわれず、新しい価値を創造し続ける。',
    image: 'bg-gradient-to-b from-[#16161e] via-[#2a2a38] to-[#0c0c14]',
    photo: '/test/images/yonezawa1.jpg',
    hugeName: 'YONEZAWA',
    gallery: [
      { src: '/test/images/yonezawa1.jpg', alt: '米澤文雄 ポートレート' },
      { src: '/test/images/yonezawa2.jpg', alt: '調理風景' },
      { src: '/test/images/yonezawa3.jpg', alt: 'No Code' },
    ],
    career: [],
  },
  {
    ...
    photo: '/test/images/hisamatsu1.jpg',
    hugeName: 'HISAMATSU',
    gallery: [
      { src: '/test/images/hisamatsu1.jpg', alt: '久松暉典 ポートレート' },
      { src: '/test/images/hisamatsu2.jpg', alt: 'カウンターでの調理' },
      { src: '/test/images/hisamatsu3.jpg', alt: '料理' },
    ],
    career: [],
  },
];
...
export const restaurants: Restaurant[] = [
  {
    ...
    longDesc: '2025年6月、紹介制完全非公開を改め一般予約を開放。ミシュランNY三ツ星・東京一つ星のキャリアを持つ米澤文雄と、その右腕・久松暉典による新ジャンル「メキシカンフレンチ」。世界中のフーディから寵愛を受けるメキシカンとフレンチの融合に、日本の文化・食材を織りなす唯一無二の料理。シェフとの距離0mのカウンターテーブルで味わう、新しいダイニングエクスペリエンスをお愉しみください。',
  ...
  },
  {
    ...
    slug: 'taipei',
    desc: 'No Codeの哲学を台北へ。日本の精緻な技法と台湾の豊かな食材が融合する唯一無二のダイニング。',
    longDesc: '東京・西麻布で生まれたNo Codeの哲学が、台北に上陸。日本の精緻な技法と台湾の豊かな食材を融合させ、唯一無二の味覚体験を創造します。ランチ・ディナーともに、季節ごとに変わる台湾食材の新たな可能性をお届けします。',
    address: '台北市內湖區舊宗路1段155號1樓\n1 F., No. 155, Sec. 1, Jiuzong Rd., Neihu Dist., Taipei City 114066, Taiwan (R.O.C.)',
    hours: 'ランチ 12:00–14:00\nディナー 18:00–21:00',
    phone: '+886 2 8791 7267',
    seats: '44席',
    style: '予約方法：電話予約',
    image: 'bg-gradient-to-br from-[#0a1520] via-[#1a2a3a] to-[#050a12]',
    gallery: [
      { src: '/test/images/taipei1.jpg', alt: '店内' },
      { src: '/test/images/taipei2.jpg', alt: '料理' },
      { src: '/test/images/taipei3.jpg', alt: 'カウンター' },
      { src: '/test/images/taipei4.jpg', alt: '空間' },
    ],
    link: '/test/taipei',
  },
];
